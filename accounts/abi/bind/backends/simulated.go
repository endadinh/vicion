...
import (
	...
	"github.com/vicion/vicion/core/rawdb"
	"math/big"
	"sync"
	"time"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call vicion.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) CallContractWithState(call vicion.CallMsg, chain consensus.ChainContext, statedb *state.StateDB) ([]byte, error) {
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call vicion.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call vicion.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call vicion.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
	// Ensure message is initialized properly.
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query vicion.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query vicion.FilterQuery, ch chan<- types.Log) (vicion.Subscription, error) {
