...
import (
	...
	blockSignerContract "github.com/vicion/vicion/contracts/blocksigner"
	multiSignWalletContract "github.com/vicion/vicion/contracts/multisigwallet"
	randomizeContract "github.com/vicion/vicion/contracts/randomize"
	validatorContract "github.com/vicion/vicion/contracts/validator"
...
func (w *wizard) makeGenesis() {
	...
	case choice == "" || choice == "3":
		...
		fmt.Println()
		fmt.Println("What is swap wallet address for fund 55m vicion?")
