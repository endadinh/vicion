...
import (
	...
	"github.com/vicion/vicion/swarm"
	bzzapi "github.com/vicion/vicion/swarm/api"
	swarmmetrics "github.com/vicion/vicion/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//vicion only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for vicion and swarm
