...
const (
	clientIdentifier = "vicion" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the vicion command line interface")
	...
	nodeFlags = []cli.Flag{
		...
		utils.VicionXEnabledFlag,
		utils.VicionXDataDirFlag,
		utils.VicionXDBEngineFlag,
		utils.VicionXDBConnectionUrlFlag,
		utils.VicionXDBReplicaSetNameFlag,
		utils.VicionXDBNameFlag,
...
func init() {
	// Initialize the CLI app and start vicion
	app.Action = vicion
...
// vicion is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func vicion(ctx *cli.Context) error {
...
// miner.
func startNode(ctx *cli.Context, stack *node.Node, cfg vicionConfig) {
