...
var TIPVicionX = big.NewInt(20581700)
var TIPVicionXLending = big.NewInt(21430200)
var TIPVicionXCancellationFee = big.NewInt(30915660)
var TIPVicionXTestnet = big.NewInt(0)
var IsTestnet bool = false
var StoreRewardFolder string
var RollbackHash Hash
var BasePrice = big.NewInt(1000000000000000000)                             // 1
var RelayerLockedFund = big.NewInt(20000)                                   // 20000 VICION
var RelayerFee = big.NewInt(1000000000000000)                               // 0.001
var VicionXBaseFee = big.NewInt(10000)                                      // 1 / VicionXBaseFee
var RelayerCancelFee = big.NewInt(100000000000000)                          // 0.0001
var VicionXBaseCancelFee = new(big.Int).Mul(VicionXBaseFee, big.NewInt(10)) // 1/ (VicionXBaseFee *10)
...
var VicionXListingSMC = HexToAddress("0xDE34dD0f536170993E8CFF639DdFfCF1A85D3E53")
var VicionXListingSMCTestNet = HexToAddress("0x14B2Bf043b9c31827A472CE4F94294fE9a6277e0")
