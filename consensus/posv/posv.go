...
import (
	...
	"github.com/vicion/vicion/consensus/clique"
...
type TradingService interface {
	...
	ApplyOrder(header *types.Header, coinbase common.Address, chain consensus.ChainContext, statedb *state.StateDB, vicionXstatedb *tradingstate.TradingStateDB, orderBook common.Hash, order *tradingstate.OrderItem) ([]map[string]string, []*tradingstate.OrderItem, error)
...
type Posv struct {
	...
	GetVicionXService          func() TradingService
...
func (c *Posv) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (int, int, int, bool, error) {
	...
	if common.IsTestnet {
		// Only three mns hard code for vicion testnet.
