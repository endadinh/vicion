...
import (
	...
	"github.com/vicion/vicion/contracts/trc21issuer"
	"github.com/vicion/vicion/contracts/trc21issuer/simulation"
...
func testTransferTRC21TokenWithAccountNoTomo() {
	...
	// access to address which received token trc20 but dont have vicion
...
func main() {
	...
	for i := 0; i < 10000000; i++ {
		...
		fmt.Println("Finish transfer trc21 token with a account no vicion")
		testTransferTrc21Fail()
		fmt.Println("Finish testing ! Success transferAmount token trc20 with a account no vicion")
	}
