...
// LAbstractVICIONXListingABI is the input ABI used to generate the binding from.
const LAbstractVICIONXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractVICIONXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractVICIONXListingBin = `0x`

// DeployLAbstractVICIONXListing deploys a new Ethereum contract, binding an instance of LAbstractVICIONXListing to it.
func DeployLAbstractVICIONXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractVICIONXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractVICIONXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractVICIONXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractVICIONXListing{LAbstractVICIONXListingCaller: LAbstractVICIONXListingCaller{contract: contract}, LAbstractVICIONXListingTransactor: LAbstractVICIONXListingTransactor{contract: contract}, LAbstractVICIONXListingFilterer: LAbstractVICIONXListingFilterer{contract: contract}}, nil
}

// LAbstractVICIONXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractVICIONXListing struct {
	LAbstractVICIONXListingCaller     // Read-only binding to the contract
	LAbstractVICIONXListingTransactor // Write-only binding to the contract
	LAbstractVICIONXListingFilterer   // Log filterer for contract events
}

// LAbstractVICIONXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractVICIONXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractVICIONXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractVICIONXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractVICIONXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractVICIONXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractVICIONXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractVICIONXListingSession struct {
	Contract     *LAbstractVICIONXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts          // Call options to use throughout this session
	TransactOpts bind.TransactOpts      // Transaction auth options to use throughout this session
}

// LAbstractVICIONXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractVICIONXListingCallerSession struct {
	Contract *LAbstractVICIONXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                // Call options to use throughout this session
}

// LAbstractVICIONXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractVICIONXListingTransactorSession struct {
	Contract     *LAbstractVICIONXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                // Transaction auth options to use throughout this session
}

// LAbstractVICIONXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractVICIONXListingRaw struct {
	Contract *LAbstractVICIONXListing // Generic contract binding to access the raw methods on
}

// LAbstractVICIONXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractVICIONXListingCallerRaw struct {
	Contract *LAbstractVICIONXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractVICIONXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractVICIONXListingTransactorRaw struct {
	Contract *LAbstractVICIONXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractVICIONXListing creates a new instance of LAbstractVICIONXListing, bound to a specific deployed contract.
func NewLAbstractVICIONXListing(address common.Address, backend bind.ContractBackend) (*LAbstractVICIONXListing, error) {
	contract, err := bindLAbstractVICIONXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractVICIONXListing{LAbstractVICIONXListingCaller: LAbstractVICIONXListingCaller{contract: contract}, LAbstractVICIONXListingTransactor: LAbstractVICIONXListingTransactor{contract: contract}, LAbstractVICIONXListingFilterer: LAbstractVICIONXListingFilterer{contract: contract}}, nil
}

// NewLAbstractVICIONXListingCaller creates a new read-only instance of LAbstractVICIONXListing, bound to a specific deployed contract.
func NewLAbstractVICIONXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractVICIONXListingCaller, error) {
	contract, err := bindLAbstractVICIONXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractVICIONXListingCaller{contract: contract}, nil
}

// NewLAbstractVICIONXListingTransactor creates a new write-only instance of LAbstractVICIONXListing, bound to a specific deployed contract.
func NewLAbstractVICIONXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractVICIONXListingTransactor, error) {
	contract, err := bindLAbstractVICIONXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractVICIONXListingTransactor{contract: contract}, nil
}

// NewLAbstractVICIONXListingFilterer creates a new log filterer instance of LAbstractVICIONXListing, bound to a specific deployed contract.
func NewLAbstractVICIONXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractVICIONXListingFilterer, error) {
	contract, err := bindLAbstractVICIONXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractVICIONXListingFilterer{contract: contract}, nil
}

// bindLAbstractVICIONXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractVICIONXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractVICIONXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractVICIONXListing.Contract.LAbstractVICIONXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractVICIONXListing.Contract.LAbstractVICIONXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractVICIONXListing.Contract.LAbstractVICIONXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractVICIONXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractVICIONXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractVICIONXListing *LAbstractVICIONXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractVICIONXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractVICIONXListing *LAbstractVICIONXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractVICIONXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractVICIONXListing *LAbstractVICIONXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractVICIONXListing.Contract.GetTokenStatus(&_LAbstractVICIONXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractVICIONXListing *LAbstractVICIONXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractVICIONXListing.Contract.GetTokenStatus(&_LAbstractVICIONXListing.CallOpts, arg0)
}
...
// VicionXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function VicionXListing() constant returns(address)
func (_Lending *LendingCaller) VicionXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "VicionXListing")
	return *ret0, err
}
...
//
// Solidity: function VicionXListing() constant returns(address)
func (_Lending *LendingSession) VicionXListing() (common.Address, error) {
	return _Lending.Contract.VicionXListing(&_Lending.CallOpts)
}

// VicionXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function VicionXListing() constant returns(address)
func (_Lending *LendingCallerSession) VicionXListing() (common.Address, error) {
	return _Lending.Contract.VicionXListing(&_Lending.CallOpts)
}
