...
var (
	...
	skipNonceDestinationAddress = map[string]bool{
		common.VicionXAddr:                         true,
		common.TradingStateAddr:                    true,
		common.VicionXLendingAddress:               true,
		common.VicionXLendingFinalizedTradeAddress: true,
	}
)
...
func (tx *Transaction) IsTradingTransaction() bool {
	...
	if tx.To().String() != common.VicionXAddr {
		return false
	}
...
func (tx *Transaction) IsLendingTransaction() bool {
	...
	if tx.To().String() != common.VicionXLendingAddress {
		return false
	}
	return true
}
...
func (tx *Transaction) IsLendingFinalizedTradeTransaction() bool {
	...
	if tx.To().String() != common.VicionXLendingFinalizedTradeAddress {
		return false
	}
	return true
}
...
func (tx *Transaction) IsVicionXApplyTransaction() bool {
	if tx.To() == nil {
		return false
	}

	addr := common.VicionXListingSMC
	if common.IsTestnet {
		addr = common.VicionXListingSMCTestNet
	}
	...
	if method != common.VicionXApplyMethod {
		return false
	}
