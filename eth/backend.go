...
import (
	...
	"github.com/vicion/vicion/internal/ethapi"
	"github.com/vicion/vicion/log"
	"github.com/vicion/vicion/miner"
...
type Ethereum struct {
	...
	Lending *vicionxlending.Lending
}
...
func New(ctx *node.ServiceContext, config *Config, vicionXServ *vicionx.VicionX, lendingServ *vicionxlending.Lending) (*Ethereum, error) {
	...
	// Inject VicionX Service into main Eth Service.
	if vicionXServ != nil {
		eth.VicionX = vicionXServ
	}
	if lendingServ != nil {
	...
	if eth.chainConfig.Posv != nil {
		...
		c.GetVicionXService = func() posv.TradingService {
			return eth.VicionX
		}
	...
	eth.blockchain, err = core.NewBlockChainEx(chainDb, vicionXServ.GetLevelDB(), cacheConfig, eth.chainConfig, eth.engine, vmConfig)
	if err != nil {
		return nil, err
	}
...
func (s *Ethereum) GetVicionX() *vicionx.VicionX {
	return s.VicionX
}
...
func (s *Ethereum) GetVicionXLending() *vicionxlending.Lending {
	return s.Lending
}
