...
import (
	...
	"github.com/vicion/vicion/vicionxlending/lendingstate"

	"github.com/vicion/vicion/vicionx/tradingstate"

	"github.com/syndtr/goleveldb/leveldb"
	"github.com/syndtr/goleveldb/leveldb/util"
	"github.com/vicion/vicion/accounts"
	"github.com/vicion/vicion/accounts/abi/bind"
	"github.com/vicion/vicion/accounts/keystore"
	"github.com/vicion/vicion/common"
	"github.com/vicion/vicion/common/hexutil"
	"github.com/vicion/vicion/common/math"
	"github.com/vicion/vicion/consensus/ethash"
	"github.com/vicion/vicion/consensus/posv"
	contractValidator "github.com/vicion/vicion/contracts/validator/contract"
	"github.com/vicion/vicion/core"
	"github.com/vicion/vicion/core/state"
	"github.com/vicion/vicion/core/types"
	"github.com/vicion/vicion/core/vm"
...
//
// https://github.com/vicion/vicion/wiki/Management-APIs#personal_sign
...
//
// https://github.com/vicion/vicion/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) doCall(ctx context.Context, args CallArgs, blockNr rpc.BlockNumber, vmCfg vm.Config, timeout time.Duration) ([]byte, uint64, bool, error) {
	...
	vicionxState, err := s.b.TomoxService().GetTradingState(block, author)
	if err != nil {
		return nil, 0, false, err
	}
	// Get a new instance of the EVM.
	evm, vmError, err := s.b.GetEVM(ctx, msg, statedb, vicionxState, header, vmCfg)
	if err != nil {
		return nil, 0, false, err
	}
...
// PublicTransactionPoolAPI exposes methods for the RPC interface
type PublicVicionXTransactionPoolAPI struct {
	b         Backend
	nonceLock *AddrLocker
}
...
// NewPublicTransactionPoolAPI creates a new RPC service with methods specific for the transaction pool.
func NewPublicVicionXTransactionPoolAPI(b Backend, nonceLock *AddrLocker) *PublicVicionXTransactionPoolAPI {
	return &PublicVicionXTransactionPoolAPI{b, nonceLock}
}
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicVicionXTransactionPoolAPI) SendOrderRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicVicionXTransactionPoolAPI) SendLendingRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
func (s *PublicVicionXTransactionPoolAPI) GetOrderTxMatchByHash(ctx context.Context, hash common.Hash) ([]*tradingstate.OrderItem, error) {
	var tx *types.Transaction
...
func (s *PublicVicionXTransactionPoolAPI) GetOrderPoolContent(ctx context.Context) interface{} {
...
func (s *PublicVicionXTransactionPoolAPI) GetOrderStats(ctx context.Context) interface{} {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicVicionXTransactionPoolAPI) SendOrder(ctx context.Context, msg OrderMsg) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicVicionXTransactionPoolAPI) SendLending(ctx context.Context, msg LendingMsg) (common.Hash, error) {
...
func (s *PublicVicionXTransactionPoolAPI) GetOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
...
func (s *PublicVicionXTransactionPoolAPI) GetBestBid(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	...
	vicionxService := s.b.TomoxService()
	if vicionxService == nil {
		return result, errors.New("VicionX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
	}
	vicionxState, err := vicionxService.GetTradingState(block, author)
	if err != nil {
		return result, err
	}
	result.Price, result.Volume = vicionxState.GetBestBidPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicVicionXTransactionPoolAPI) GetBestAsk(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	result := PriceVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
	...
	result.Price, result.Volume = vicionxState.GetBestAskPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if result.Price.Sign() == 0 {
...
func (s *PublicVicionXTransactionPoolAPI) GetBidTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
	...
	vicionxService := s.b.TomoxService()
	if vicionxService == nil {
		return nil, errors.New("VicionX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
	...
	result, err := vicionxState.DumpBidTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := vicionxState.GetLastPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicVicionXTransactionPoolAPI) GetLastEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := vicionxState.GetMediumPriceBeforeEpoch(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetCurrentEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price, _ := vicionxState.GetMediumPriceAndTotalAmount(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetAskTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := vicionxState.DumpAskTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetOrderById(ctx context.Context, baseToken, quoteToken common.Address, orderId uint64) (interface{}, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	orderitem := vicionxState.GetOrder(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken), orderIdHash)
...
func (s *PublicVicionXTransactionPoolAPI) GetTradingOrderBookInfo(ctx context.Context, baseToken, quoteToken common.Address) (*tradingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := vicionxState.DumpOrderBookInfo(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetLiquidationPriceTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpLendingBook, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := vicionxState.DumpLiquidationPriceTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetInvestingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	if lendingService == nil {
		return nil, errors.New("VicionX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
...
func (s *PublicVicionXTransactionPoolAPI) GetBorrowingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingOrderBookInfo(tx context.Context, lendingToken common.Address, term uint64) (*lendingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) getLendingOrderTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingItem, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingTradeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingTrade, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetLiquidationTimeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetBestInvesting(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return result, errors.New("VicionX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
...
func (s *PublicVicionXTransactionPoolAPI) GetBestBorrowing(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	result := InterestVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
...
func (s *PublicVicionXTransactionPoolAPI) GetBids(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := vicionxState.GetBids(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetAsks(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := vicionxState.GetAsks(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicVicionXTransactionPoolAPI) GetInvests(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetBorrows(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingTxMatchByHash(ctx context.Context, hash common.Hash) ([]*lendingstate.LendingItem, error) {
	var tx *types.Transaction
	if tx, _, _, _ = core.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
// GetLiquidatedTradesByTxHash returns trades which closed by VicionX protocol at the tx of the give hash
func (s *PublicVicionXTransactionPoolAPI) GetLiquidatedTradesByTxHash(ctx context.Context, hash common.Hash) (lendingstate.FinalizedResult, error) {
	var tx *types.Transaction
	if tx, _, _, _ = core.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingOrderById(ctx context.Context, lendingToken common.Address, term uint64, orderId uint64) (lendingstate.LendingItem, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return lendingItem, errors.New("VicionX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
...
func (s *PublicVicionXTransactionPoolAPI) GetLendingTradeById(ctx context.Context, lendingToken common.Address, term uint64, tradeId uint64) (lendingstate.LendingTrade, error) {
