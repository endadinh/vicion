...
import (
	...
	"github.com/vicion/vicion/light"
...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, vicionxState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), math.MaxBig256)
	context := core.NewEVMContext(msg, header, b.eth.blockchain, nil)
	return vm.NewEVM(context, state, vicionxState, b.eth.chainConfig, vmCfg), state.Error, nil
}
...
func (b *LesApiBackend) TomoxService() *vicionx.VicionX {
	return nil
}

func (b *LesApiBackend) LendingService() *vicionxlending.Lending {
	return nil
}
