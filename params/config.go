...
func (c *ChainConfig) IsPetersburg(num *big.Int) bool {
	return isForked(common.TIPVicionXCancellationFee, num)
}
...
func (c *ChainConfig) IsTIPVicionX(num *big.Int) bool {
	if common.IsTestnet {
		return isForked(common.TIPVicionXTestnet, num)
	} else {
		return isForked(common.TIPVicionX, num)
	}
}

func (c *ChainConfig) IsTIPVicionXLending(num *big.Int) bool {
	return isForked(common.TIPVicionXLending, num)
}

func (c *ChainConfig) IsTIPVicionXCancellationFee(num *big.Int) bool {
	return isForked(common.TIPVicionXCancellationFee, num)
}
