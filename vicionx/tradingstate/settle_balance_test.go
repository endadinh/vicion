...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"BUY, quote is not VICION, makerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is not VICION, takerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is VICION, makerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"BUY, quote is VICION, takerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is not VICION, makerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is not VICION, takerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is VICION, makerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is VICION, takerFee <= 0.001 VICION",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
