...
// https://vicion.com
// Package vicionxDAO provides an interface to work with vicionx database, including leveldb for masternode and mongodb for SDK node
package vicionxDAO
