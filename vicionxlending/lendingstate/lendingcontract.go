...
//   - isSpecialCollateral			: TRUE if collateral is a token which is NOT available for trading in VicionX, otherwise FALSE
...
// @param statedb : current state
// @return: list of terms which vicionxlending supports
