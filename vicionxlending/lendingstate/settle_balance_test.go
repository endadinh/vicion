...
func TestGetSettleBalance(t *testing.T) {
	...
	type GetSettleBalanceArg struct {
		isVicionXLendingFork   bool
		takerSide              string
		lendTokenVICIONPrice   *big.Int
	...
	tests := []struct {
		...
		{
			"LendToken is VICION, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not VICION, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not VICION, no error, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not VICION, no error, taker INVEST",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is VICION, no error, taker invest",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is VICION, no error, taker Borrow",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := GetSettleBalance(tt.args.isVicionXLendingFork, tt.args.takerSide, tt.args.lendTokenVICIONPrice, tt.args.collateralPrice, tt.args.depositRate, tt.args.borrowFeeRate, tt.args.lendingToken, tt.args.collateralToken, tt.args.lendTokenDecimal, tt.args.collateralTokenDecimal, tt.args.quantityToLend)
