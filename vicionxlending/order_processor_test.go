...
func Test_getCancelFee(t *testing.T) {
	vicionx := vicionx.New(&vicionx.DefaultConfig)
	...
	vicionx.SetTokenDecimal(testTokenB, new(big.Int).Exp(big.NewInt(10), big.NewInt(8), nil))
	...
	tests := []struct {
		...
		// COLLATERAL TOKEN: VICION

		// zero fee test: LEND
		{
			"TokenA/VICIONzero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
		...
		// zero fee test: BORROW
		{
			"TokenA/VICION zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee: LEND
		{
			"TokenA/VICION test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee:: BORROW
		{
			"TokenA/VICION test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// LENDING TOKEN: VICION
		// COLLATERAL TOKEN: testTokenA

		// zero fee test: LEND
		{
			"VICION/TokenA zero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
		...
		// zero fee test: BORROW
		{
			"VICION/TokenA zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
		...
		// test getCancelFee: LEND
		{
			"VICION/TokenA  test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
		...
		// test getCancelFee:: BORROW
		{
			"VICION/TokenA  test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
